...
public class HttpUrlConnectionDataAgent implements NewsDataAgent {
    ...
    /**
     * step 2 : create variable for singleton pattern
     */
    private static HttpUrlConnectionDataAgent sObjectInstance;


    /**
     * step 1 : create private constructor for single pattern
     */
    private HttpUrlConnectionDataAgent() {
    }

    /**
     * step 3 : including factory create getter for single pattern
        ...
        new AsyncTask<Void,Void,Void>(){
            ...
            protected Void doInBackground(Void... voids) {
                ...
                try {
                    ...
                    Log.d(MMNewsApp.LOG_CAT, "doInBackground: " + responseString);
    ...
    @Override
    public void LoginUser(Context context, String phone, String password) {
